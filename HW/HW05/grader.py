...
grader.addHiddenPart('1a-2-hidden', lambda : testHidden('MinimaxAgent'), 6, maxSeconds=maxSeconds, description='Tests minimax')

grader.addBasicPart('2a-1-basic', lambda : testBasic('alphabeta'), 0, description='Tests alphabeta for timeout on smallClassic.')
grader.addHiddenPart('2a-2-hidden', lambda : testHidden('AlphaBetaAgent'), 6, maxSeconds=maxSeconds, description='Tests alphabeta')

grader.addBasicPart('3a-1-basic', lambda : testBasic('expectimax'), 0, maxSeconds=maxSeconds, description='Tests expectimax for timeout on smallClassic.')
grader.addHiddenPart('3a-2-hidden', lambda : testHidden('ExpectimaxAgent'), 6, maxSeconds=maxSeconds, description='Tests expectimax')
...
grader.addHiddenPart('4a-no-grading', lambda : testq4(0), 0, maxSeconds=300, extraCredit=True, description='No grading')
grader.addHiddenPart('4a-1-hidden', lambda : testq4(700), 1, extraCredit=True, description='Check if score at least 700 on smallClassic.')
grader.addHiddenPart('4a-2-hidden', lambda : testq4(1000), 1, extraCredit=True, description='Check if score at least 1000 on smallClassic.')
grader.addHiddenPart('4a-3-hidden', lambda : testq4(1200), 1, extraCredit=True, description='Check if score at least 1200 on smallClassic.')
grader.addHiddenPart('4a-4-hidden', lambda : testq4(1400), 1, extraCredit=True, description='Check if score at least 1400 on smallClassic.')
grader.addHiddenPart('4a-5-hidden', lambda : testq4(1500), 1, extraCredit=True, description='Check if score at least 1500 on smallClassic.')
